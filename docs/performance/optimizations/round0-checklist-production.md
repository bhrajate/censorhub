...
>
> - 具体落地方案与变更详情 → 见 [`round0-changelog.md`](./round0-changelog.md)
> - 第一轮完成后又发现的新问题 → 见 [`round0-audit-2026-04-16.md`](./round0-audit-2026-04-16.md)（其中 15 项已随 commit `7936e51` 落地，仅 4.5「测试覆盖不足」仍待处理）
>
